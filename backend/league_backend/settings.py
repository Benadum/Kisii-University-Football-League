...
# Use regex for production to allow any onrender.com subdomain
CORS_ALLOWED_ORIGIN_REGEXES = [
    r"^https://.*\.onrender\.com$",
]

# For local development, use a more specific list
if DEBUG:
...
# Static files (for the admin panel)
STATIC_URL = 'static/'
...
# Set Cloudinary as the default storage for all media files
